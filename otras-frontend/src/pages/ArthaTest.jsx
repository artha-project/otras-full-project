  ...
  const handleAnswerChange = async (questionId, selectedOption) => {
    ...
    if (isTier3 && activeAssessmentId) {
      try {
        ...
        console.log("%c Tier 3 Metrics Update ", "background: #1e3a8a; color: #fff; font-weight: bold; padding: 4px;");
      ...
      if (testData?.isMockTest) {
        ...
        if (targetTier === "2" || targetTier === "3") {
          ...
          console.log(`ARTHA: Tier-${targetTier} successfully processed`);
            ...
            console.log("ARTHA: Mapped scores", payload);
            console.log("ARTHA: Sending Tier-1 payload");
